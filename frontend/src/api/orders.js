...
export const updateOrderStatus = (id, status, cancellationReason) => client.put(`/orders/${id}/status`, { status, cancellation_reason: cancellationReason }).then(r => r.data);
export const getDashboard   = ()     => client.get('/dashboard/summary').then(r => r.data);
